 ...
 *     fallback_power: <bool> send a short KEY_POWER click if turning art mode
 *                           on cannot be verified through the art websocket
 *     fallback_settle: <ms>  delay after the KEY_POWER fallback before probing
 *   }
 *
...
const DEFAULTS = {
    ...
    fallback_settle: { value: 2000,   min: 0 }
};
...
module.exports = function(config) {
    ...
    output.fallback_power = raw.hasOwnProperty('fallback_power')
        ? raw.fallback_power !== false
        : true;
